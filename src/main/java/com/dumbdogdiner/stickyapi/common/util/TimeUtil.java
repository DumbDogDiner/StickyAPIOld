...
public class TimeUtil {
     ...
     * @deprecated Use the
     *             {@link com.dumbdogdiner.stickyapi.common.Translation}
    ...
    public static Timestamp toTimestamp(String timePeriod) {
        // Parse ban time.
        if (compareMany(timePeriod, new String[] { "*", "0" }))
            return null;
     ...
     * @param needles  things that may match the comparison string True if something
     *                 matches
     */
    static boolean compareMany(String haystack, String[] needles) {
